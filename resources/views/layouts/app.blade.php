        ...
        <aside class="d-flex flex-column flex-shrink-0 p-3" style="width: 18rem;">
            ...
            <nav class="nav nav-pills flex-column mb-auto">
                ...
                <a href="{{ route('projets.index') }}" class="nav-link">
                    <i class="bi bi-folder2-open fs-5"></i> Projets
                </a>
            ...
            <header class="bg-white d-flex justify-content-between align-items-center px-4 py-3 sticky-top">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <form class="position-relative mb-0" style="width: 350px; min-width: 200px;">
                        <input type="search" class="form-control ps-4 pe-5" placeholder="Type to search"
                ...
                <div class="d-flex align-items-center gap-4 fs-5 text-secondary">
                    ...
                    <button type="button" class="btn btn-link position-relative p-0 text-secondary"
                    ...
                    <!-- Profile dropdown -->
                    <div class="dropdown">
                        <button class="btn btn-link text-secondary p-0 fs-5 d-flex align-items-center gap-2"
                            id="dropdownProfile" data-bs-toggle="dropdown" aria-expanded="false" aria-haspopup="true"
